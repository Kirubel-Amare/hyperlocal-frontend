  ...
  return (
    <div className="max-w-6xl relative">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div>
          <h1 className="text-4xl font-black text-gray-900 dark:text-gray-100 tracking-tight mb-2">Earnings & Payouts</h1>
          <p className="text-lg text-gray-500 dark:text-gray-400 font-medium">Clear overview of your service revenue and payment status.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="bg-[#1E7B7C] rounded-[32px] p-8 shadow-2xl shadow-[#1E7B7C]/20 text-white">
          ...
          <button className="w-full py-4 bg-white dark:bg-gray-950 text-[#1E7B7C] rounded-2xl font-black hover:scale-[1.02] transition-all shadow-md">
            Withdraw Funds
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-gray-950/60 backdrop-blur-md rounded-[32px] p-8 shadow-xl shadow-gray-200/10 border border-white flex flex-col justify-between">
          ...
          <div>
            <div className="text-4xl font-black text-gray-900 dark:text-gray-100 mb-2">{stats.totalEarnings.amount}</div>
        ...
        <div className="bg-white dark:bg-gray-950/60 backdrop-blur-md rounded-[32px] p-8 shadow-xl shadow-gray-200/10 border border-white flex flex-col justify-between">
          ...
          <div>
            <div className="text-4xl font-black text-gray-900 dark:text-gray-100 mb-2">$850.00</div>
            <p className="text-sm font-bold text-gray-400 dark:text-gray-500">Locked in escrow for ongoing work</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-950/60 backdrop-blur-md rounded-[40px] p-10 shadow-xl shadow-gray-200/10 border border-white">
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex items-center gap-2 p-1 bg-gray-50 dark:bg-gray-900 rounded-xl">
            <button className="px-4 py-2 bg-white dark:bg-gray-950 rounded-lg shadow-sm text-xs font-black text-[#1E7B7C]">All</button>
            <button className="px-4 py-2 text-xs font-bold text-gray-400 dark:text-gray-500 hover:text-gray-600 transition-colors">Pending</button>
            <button className="px-4 py-2 text-xs font-bold text-gray-400 dark:text-gray-500 hover:text-gray-600 transition-colors">Completed</button>
          </div>
        </div>
          ...
          {[
            ...
            <div key={tx.id} className="flex items-center justify-between p-6 hover:bg-white dark:bg-gray-950/50 rounded-3xl transition-all group">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h4 className="font-black text-gray-900 dark:text-gray-100">{tx.title}</h4>
                  <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mt-1">{tx.client} • {tx.date}</p>
                </div>
              </div>
              <div className="text-right">
                <div className={`text-xl font-black mb-1 ${tx.type === 'Income' ? 'text-gray-900 dark:text-gray-100' : 'text-blue-600'}`}>{tx.amount}</div>
        ...
        <button className="w-full mt-10 py-5 bg-gray-50 dark:bg-gray-900 rounded-2xl text-sm font-black text-gray-400 dark:text-gray-500 hover:bg-gray-100/80 hover:text-gray-600 transition-all flex items-center justify-center gap-2 group">
          Load More Activity

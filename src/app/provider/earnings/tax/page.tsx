...
export default function TaxReportingPage() {
    ...
    return (
        <div className="space-y-10 animate-in fade-in duration-700 pb-24">
            {/* Header */}
            <div>
                <h1 className="text-4xl font-black text-gray-900 tracking-tight mb-2 italic">Tax & Accounting</h1>
                <p className="text-lg text-gray-500 font-medium italic">Monitor your business performance and download official tax documents.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8 space-y-8">
                    {/* Annual Summary Card */}
                    <div className="bg-white/70 backdrop-blur-xl border border-gray-100 rounded-[3rem] p-10 shadow-sm relative overflow-hidden group">
                        ...
                        <div className="relative z-10 space-y-10">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-xl font-black text-gray-900 tracking-tight italic">2024 Fiscal Year-to-Date</h2>
                                </div>
                                <span className="px-5 py-2 bg-gray-50 rounded-full text-[10px] font-black uppercase tracking-widest text-gray-400 border border-gray-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                <div className="space-y-2">
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Gross Earnings</p>
                                    <h3 className="text-5xl font-black text-gray-900 tracking-tighter">$32,450.00</h3>
                                ...
                                <div className="space-y-2">
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Platform Deductions</p>
                                    <h3 className="text-5xl font-black text-gray-400 tracking-tighter">$4,867.50</h3>
                                    <p className="text-gray-400 text-xs font-bold italic">Standard 15% marketplace fee applied</p>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                                <div className="flex gap-12">
                                    <div>
                                        ...
                                        <p className="text-lg font-black text-gray-900">$840.20</p>
                                    </div>
                                    <div>
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Net Income</p>
                ...
                <div className="lg:col-span-4 space-y-6">
                    <div className="bg-white border border-gray-100 rounded-[3rem] p-8 shadow-sm space-y-8">
                        <div>
                            <h3 className="text-lg font-black text-gray-900 italic mb-2 tracking-tight">Available Documents</h3>
                            <p className="text-xs text-gray-400 font-medium italic leading-relaxed">Official tax forms and financial statements ready for download.</p>
                        </div>
                            ...
                            {historicalDocs.map((doc, idx) => (
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-xl bg-gray-50 group-hover:bg-white text-gray-400 group-hover:text-[#1E7B7C] flex items-center justify-center transition-all shadow-sm">
                                            <FileText size={20} />
                                        </div>
                                        <div>
                                            <h4 className="text-sm font-black text-gray-900">{doc.type} ({doc.year})</h4>
                                            <p className="text-[10px] text-gray-400 font-bold uppercase mt-0.5">{doc.date}</p>
                                        </div>
                                    </div>

                    ...
                    <div className="bg-gray-900 rounded-[3rem] p-10 text-white relative overflow-hidden shadow-2xl shadow-gray-400/20 group">
                        ...
                        <div className="relative z-10 space-y-8">
                            <div className="flex items-center gap-3">
                                <div className="p-3 bg-white/20 dark:bg-white/5 rounded-2xl backdrop-blur-md border border-white/10 dark:border-gray-800/10">
                            ...
                            <div className="flex flex-wrap gap-4 pt-4">
                                ...
                                <button className="px-8 py-4 bg-white/20 dark:bg-white/5 border border-white/10 text-white rounded-[2rem] font-black hover:bg-white transition-all dark:border-gray-800/10">

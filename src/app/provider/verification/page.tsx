    ...
    return (
        <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            ...
            <div className="text-center mb-12">
                ...
                <h1 className="text-4xl font-black text-gray-900 tracking-tight mb-4 italic">Identity Verification 2.0</h1>
                ...
                {steps.map((s, idx) => {
                    ...
                    return (
                        <div key={s.id} className="relative z-10 flex flex-col items-center">
                            <div className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all duration-500 shadow-lg ${isActive ? 'bg-[#1E7B7C] text-white scale-110' : 'bg-white text-gray-400 border border-gray-100'
                                }`}>
                                {idx < currentStepIndex ? <CheckCircle2 size={20} /> : <span className="text-sm font-black">{idx + 1}</span>}
                            </div>
                            <span className={`text-[10px] font-black uppercase tracking-widest mt-4 ${isActive ? 'text-[#1E7B7C]' : 'text-gray-400'}`}>
                                {s.label}
                            </span>
                        </div>
                    );
            ...
            {/* Main Card */}
            <div className="bg-white/60 backdrop-blur-xl border border-white rounded-[40px] p-8 md:p-12 shadow-2xl shadow-gray-200/20 relative overflow-hidden min-h-[500px] flex flex-col">
                ...
                {step === 'intro' && (
                    <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 animate-in fade-in zoom-in duration-500">
                        ...
                        <div className="space-y-4 max-w-sm">
                            <h2 className="text-2xl font-black text-gray-900">Why Verify?</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-left">
                                ...
                                <h4 className="text-xs font-black text-gray-900 uppercase">Secured by Stripe</h4>
                                <p className="text-[10px] text-gray-400 font-bold">End-to-end encrypted storage</p>
                            </div>
                            <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 text-left">
                                <CheckCircle2 className="text-[#1E7B7C] mb-2" size={20} />
                                <h4 className="text-xs font-black text-gray-900 uppercase">Verified Badge</h4>
                                <p className="text-[10px] text-gray-400 font-bold">Visible on search and profile</p>
                            </div>
                        </div>
                        <button
                ...
                {step === 'identity' && (
                    <div className="flex-1 space-y-8 animate-in slide-in-from-right-8 duration-500">
                        <div>
                            <h2 className="text-2xl font-black text-gray-900">Upload Government ID</h2>
                            <p className="text-gray-500 text-sm font-medium">Please upload a clear photo of your Driver's License or International Passport.</p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <label className={`relative group cursor-pointer border-2 border-dashed rounded-3xl p-8 transition-all flex flex-col items-center justify-center min-h-[220px] ${idFront ? 'border-[#1E7B7C] bg-emerald-50/20' : 'border-gray-100 bg-gray-50/50 hover:bg-gray-50'
                                }`}>
                                ...
                                {idFront ? (
                                    ...
                                    <>
                                        <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center text-gray-400 group-hover:text-[#1E7B7C] transition-colors mb-4 italic">
                                            <Upload size={24} />
                                        </div>
                                        <span className="text-xs font-black text-gray-400 uppercase tracking-widest">ID Front Side</span>
                                    </>
                                )}
                            </label>

                            <label className={`relative group cursor-pointer border-2 border-dashed rounded-3xl p-8 transition-all flex flex-col items-center justify-center min-h-[220px] ${idBack ? 'border-[#1E7B7C] bg-emerald-50/20' : 'border-gray-100 bg-gray-50/50 hover:bg-gray-50'
                                }`}>
                                ...
                                {idBack ? (
                                    ...
                                    <>
                                        ...
                                        <span className="text-xs font-black text-gray-400 uppercase tracking-widest">ID Back Side</span>
                                    </>
                                )}
                            </label>
                        </div>
                        ...
                        <div className="flex gap-4 mt-auto">
                            <button onClick={() => setStep('intro')} className="flex-1 py-4 rounded-3xl border-2 border-gray-100 text-gray-400 font-black hover:bg-gray-50 transition-all">Back</button>
                            <button
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 animate-in slide-in-from-right-8 duration-500">
                        <div className="w-48 h-48 rounded-full border-4 border-dashed border-[#1E7B7C] p-2 relative">
                            {selfie ? (
                                ...
                                <div className="w-full h-full rounded-full bg-gray-50 flex flex-col items-center justify-center text-gray-300">
                        ...
                        <div className="space-y-2">
                            <h2 className="text-2xl font-black text-gray-900 italic underline decoration-[#1E7B7C]/30">Liveness Check</h2>
                            <p className="text-gray-500 text-sm font-medium max-w-sm">Capture a live selfie to confirm your identity matches your uploaded document.</p>
                        </div>
                        <div className="flex gap-4 w-full">
                            <button onClick={() => setStep('identity')} className="flex-1 py-4 rounded-3xl border-2 border-gray-100 text-gray-400 font-black hover:bg-gray-50 transition-all">Back</button>
                            <button
                ...
                {step === 'license' && (
                    <div className="flex-1 space-y-8 animate-in slide-in-from-right-8 duration-500">
                        <div>
                            <h2 className="text-2xl font-black text-gray-900 italic">Professional Credentials</h2>
                            <p className="text-gray-500 text-sm font-medium">Upload your business license, liability insurance, or trade certification (Optional but recommended).</p>
                        </div>

                        <label className={`relative group cursor-pointer border-2 border-dashed rounded-[32px] p-12 transition-all flex flex-col items-center justify-center ${license ? 'border-[#1E7B7C] bg-emerald-50/20' : 'border-gray-100 bg-gray-50/50 hover:bg-gray-100'
                            }`}>
                            <input type="file" className="hidden" onChange={(e) => setLicense(e.target.files![0].name)} />
                            <div className={`w-20 h-20 rounded-3xl bg-white shadow-md flex items-center justify-center mb-6 transition-all duration-500 ${license ? 'text-emerald-500 scale-110' : 'text-gray-300 group-hover:text-[#1E7B7C]'}`}>
                                <FileText size={40} />
                            </div>
                            <span className="text-sm font-black text-gray-600 mb-2 uppercase tracking-widest">{license || "Upload Document"}</span>
                            <span className="text-xs text-gray-400 font-bold">PDF, JPEG, or PNG (Max 5MB)</span>
                        </label>

                        <div className="flex gap-4 mt-auto">
                            <button onClick={() => setStep('selfie')} className="flex-1 py-4 rounded-3xl border-2 border-gray-100 text-gray-400 font-black hover:bg-gray-50 transition-all">Back</button>
                            <button
                ...
                {step === 'submitting' && (
                    <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 animate-in zoom-in duration-500">
                        <div className="relative">
                            <div className="w-24 h-24 rounded-full border-4 border-gray-100 border-t-[#1E7B7C] animate-spin" />
                            <ShieldCheck size={40} className="absolute inset-0 m-auto text-[#1E7B7C]" />
                        </div>
                        <div className="space-y-2">
                            <h2 className="text-2xl font-black text-gray-900 tracking-tighter italic">Analyzing Identity Matrix</h2>
                            <p className="text-gray-500 text-sm font-medium">Our biometric engine is currently matching your attributes...</p>
                        </div>
                        <div className="w-full max-w-xs h-2 bg-gray-50 rounded-full overflow-hidden">
                ...
                {step === 'success' && (
                    <div className="flex-1 flex flex-col items-center justify-center text-center space-y-8 animate-in slide-in-from-bottom-8 duration-700">
                        ...
                        <div className="space-y-3">
                            <h2 className="text-3xl font-black text-gray-900 tracking-tight italic">Success! Under Review</h2>
                            <p className="text-gray-500 font-medium max-w-md">
                                Your documentation has been submitted successfully. Our safety team will review your credentials within <span className="text-gray-900 font-black">24-48 hours</span>.
                            </p>
                        </div>

                        <div className="p-6 bg-emerald-50/50 rounded-3xl border border-emerald-100 w-full max-w-sm flex items-center gap-4">
                            <div className="p-3 bg-white rounded-2xl shadow-sm text-emerald-500 font-black italic">
                                <ShieldCheck size={24} />
                            </div>

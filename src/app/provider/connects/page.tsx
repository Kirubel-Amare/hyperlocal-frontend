  ...
  return (
    <div className="max-w-6xl relative pb-24">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="bg-white dark:bg-gray-950/90 backdrop-blur-2xl w-full max-w-lg rounded-[48px] p-10 shadow-2xl relative z-10 border border-white dark:border-gray-800 animate-in zoom-in-95 duration-300">
            ...
            <div className="mb-8 font-sans">
              ...
              <h2 className="text-3xl font-black text-gray-900 dark:text-gray-100 tracking-tight">Complete Purchase</h2>
              <p className="text-gray-500 dark:text-gray-400 font-medium mt-1">Refill your balance with {selectedPkg?.connects} connects.</p>
            </div>

            <div className="bg-gray-50/50 dark:bg-gray-900/50 rounded-3xl p-6 mb-8 border border-gray-100 dark:border-gray-800 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-black text-gray-900 dark:text-gray-100">{selectedPkg?.connects} Connects Package</h4>
                  <p className="text-xs font-bold text-gray-400 dark:text-gray-500">Instant delivery to your account</p>
                </div>
              </div>
              <div className="text-2xl font-black text-gray-900 dark:text-gray-100">{selectedPkg?.price}</div>
            </div>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div>
          <h1 className="text-4xl font-black text-gray-900 dark:text-gray-100 tracking-tight mb-2">Service Credits</h1>
          <p className="text-lg text-gray-500 dark:text-gray-400 font-medium">Manage your connects used for applying to service requests.</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white dark:bg-gray-950/60 backdrop-blur-md rounded-[32px] p-8 shadow-xl shadow-gray-200/5 border border-white dark:border-gray-800 flex flex-col justify-between h-72">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 text-center uppercase tracking-[0.2em]">Dynamic pricing based on demand</p>
          </div>
        </div>
      </div>
              ...
              <div key={pkg.id} className={`p-1 rounded-[30px] transition-all relative group ${pkg.popular ? 'bg-gradient-to-r from-[#1E7B7C] to-[#166566] shadow-xl shadow-[#1E7B7C]/20' : 'bg-transparent border border-gray-100 dark:border-gray-800'}`}>
                ...
                >
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <h4 className="text-2xl font-black text-gray-900 dark:text-gray-100 leading-tight">{pkg.connects}</h4>
                      <p className="text-sm font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">Connects</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-6">
                    <div className="text-2xl font-black text-gray-900 dark:text-gray-100">{pkg.price}</div>
                    ...
                    <div className={`w-10 h-10 rounded-full border-2 flex items-center justify-center transition-all ${pkg.popular ? 'border-[#1E7B7C] bg-[#1E7B7C] shadow-lg shadow-[#1E7B7C]/20' : 'border-gray-100 dark:border-gray-800 group-hover:border-[#1E7B7C] group-hover:bg-[#E8F4F4]'}`}>
            ...
            {mockLogTransactions.map((log) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-black text-gray-900 dark:text-gray-100 text-[15px] mb-0.5">{log.title}</h4>
                    <p className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">{log.date}</p>
                  </div>
                </div>
                <div className={`text-xl font-black ${log.amount.startsWith('+') ? 'text-emerald-500' : 'text-gray-900 dark:text-gray-100'}`}>
                  {log.amount}
                </div>
              </div>
            ))}

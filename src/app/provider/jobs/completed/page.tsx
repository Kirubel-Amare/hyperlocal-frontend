    ...
    <div className="max-w-6xl relative pb-24">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div>
          ...
          <p className="text-lg text-gray-500 font-medium">Review your past work, client feedback, and completed earnings.</p>
        </div>
        <div className="flex p-1 bg-gray-100/50 backdrop-blur-md rounded-2xl border border-gray-100 shadow-inner w-fit">
          <Link href="/provider/jobs/active" className="px-6 py-2.5 text-gray-400 hover:text-gray-600 rounded-xl text-sm font-bold transition-all">
            Active
          </Link>
      ...
      <div className="bg-white/60 backdrop-blur-md rounded-[40px] p-10 shadow-xl shadow-gray-200/10 border border-white">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-10">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-transparent focus:border-[#1E7B7C]/20 rounded-2xl outline-none transition-all font-medium text-gray-900 placeholder-gray-400"
            />
          </div>
          <button className="px-6 py-4 bg-gray-50 rounded-2xl font-black text-gray-500 hover:bg-gray-100 transition-all flex items-center gap-2 border border-gray-100 border-b-4 active:border-b active:translate-y-[3px]">
            <Filter size={18} />
            Filter By Date
          </button>
        </div>
        ...
        <div className="space-y-6">
          {completedJobs.map((job) => (
            <div key={job.id} className="group bg-white border border-gray-100 hover:border-[#1E7B7C]/20 p-8 rounded-[32px] shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col md:flex-row gap-8 relative overflow-hidden">
              ...
              <div className="flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-4 text-xs font-bold text-gray-400 mb-6">
                    ...
                    <span>•</span>
                    <span className="text-gray-900">Client: {job.client}</span>
                  </div>
                </div>
              ...
              {/* Earnings & Actions */}
              <div className="flex flex-col justify-between items-end min-w-[140px] pl-6 border-l border-gray-100 md:h-32">
                <div className="text-right">
                  <div className="text-xs font-black text-gray-400 uppercase tracking-widest mb-1">Earned</div>
                  <div className="text-3xl font-black text-gray-900">{job.amount}</div>
                </div>
        ...
        <div className="mt-10 flex justify-center">
          <button className="px-8 py-4 bg-gray-50 text-gray-500 font-black rounded-2xl hover:bg-gray-100 transition-colors flex items-center gap-2">
            Load Older Jobs
            <ChevronRight size={16} />
          </button>
        </div>

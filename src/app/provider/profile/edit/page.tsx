...
export default function ProviderProfileEditPage() {
    ...
    return (
        <div className="max-w-6xl relative pb-24">
            ...
            <div className="sticky top-0 z-50 -mx-6 md:-mx-12 lg:-mx-16 px-6 md:px-12 lg:px-16 py-4 bg-white/80 backdrop-blur-xl border-b border-gray-100 mb-10 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-4">
                    <Link href="/provider/profile" className="p-2 text-gray-400 hover:bg-gray-100 rounded-xl transition-colors">
                        <X size={24} />
                    </Link>
                    <div>
                        <h1 className="text-xl font-black text-gray-900 tracking-tight">Edit Profile</h1>
                        <p className="text-xs font-bold text-gray-500">Unsaved changes</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <Link href="/provider/profile" className="px-6 py-2.5 text-gray-500 font-bold hover:bg-gray-50 rounded-xl transition-colors text-sm">
                        Cancel
                    </Link>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                <div className="lg:col-span-3 space-y-8">
                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-[32px] p-8 border border-white shadow-xl shadow-gray-200/10">
                        <h2 className="text-2xl font-black text-gray-900 mb-8">Profile Photo & Title</h2>

                        <div className="flex flex-col sm:flex-row gap-8 items-start mb-8 pb-8 border-b border-gray-100">
                            {/* Photo Upload */}
                            ...
                            <div className="flex-1 space-y-6 w-full">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl font-bold text-gray-900 focus:outline-none focus:border-[#1E7B7C] focus:ring-4 focus:ring-[#1E7B7C]/10 transition-all"
                                    />
                                </div>
                                <div>
                                    <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Professional Headline</label>
                                    <input
                                        type="text"
                                    ...
                                    />
                                    <p className="text-xs font-medium text-gray-400 mt-2">A strong title helps you stand out in search results.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mb-8 pb-8 border-b border-gray-100">
                            ...
                            <textarea
                                ...
                                className="w-full px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-2xl font-medium text-gray-700 leading-relaxed focus:outline-none focus:border-[#1E7B7C] focus:ring-4 focus:ring-[#1E7B7C]/10 transition-all resize-y"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Hourly Rate ($)</label>
                                <div className="relative">
                                    <DollarSign size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
                                    <input
                                        type="number"
                                        defaultValue="45.00"
                                        className="w-full pl-10 pr-5 py-3.5 bg-gray-50/50 border border-gray-200 rounded-xl font-bold text-gray-900 focus:outline-none focus:border-[#1E7B7C] focus:ring-4 focus:ring-[#1E7B7C]/10 transition-all"
                                    />
                                </div>
                                <p className="text-[10px] font-bold text-gray-400 mt-2 flex justify-between">
                                    <span>Client pays: $45.00/hr</span>
                                    <span className="text-[#1E7B7C]">You receive: $36.00/hr (-20% fee)</span>
                                </p>
                            </div>
                            <div>
                                <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Primary Location</label>
                                <div className="relative">
                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-[32px] p-8 border border-white shadow-xl shadow-gray-200/10">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <span className="text-sm font-bold text-gray-400">4/15 Skills Added</span>
                        </div>
                        ...
                        <div className="mb-6">
                            <input
                                ...
                                className="w-full px-5 py-4 bg-gray-50/50 border border-gray-200 rounded-xl font-medium text-gray-900 focus:outline-none focus:border-[#1E7B7C] transition-all"
                            />
                        </div>
                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-[32px] p-8 border border-white shadow-xl shadow-gray-200/10">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <button className="p-2 bg-gray-50 text-[#1E7B7C] rounded-xl hover:bg-[#E8F4F4] transition-colors border border-gray-100">
                                <Plus size={20} />
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="col-span-1 sm:col-span-2 lg:col-span-3 border-2 border-dashed border-gray-200 rounded-2xl p-10 flex flex-col items-center justify-center text-center hover:border-[#1E7B7C]/30 hover:bg-[#E8F4F4]/50 transition-all cursor-pointer group">
                                <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mb-4 group-hover:bg-white group-hover:shadow-md transition-all">
                                    <Plus size={32} className="text-gray-400 group-hover:text-[#1E7B7C]" />
                                </div>
                                <h4 className="font-black text-gray-900 mb-1">Add Portfolio Project</h4>
                                <p className="text-sm font-medium text-gray-500">Showcase your past work to win more jobs.</p>
                            </div>
                            ...
                            {[1, 2, 3].map(i => (
                                <div key={i} className="relative aspect-[4/3] rounded-2xl overflow-hidden group border border-gray-200 shadow-sm">
                                    ...
                                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4">
                                        <button className="p-2 bg-white/20 hover:bg-white/40 rounded-xl text-white transition-colors backdrop-blur-sm">
                                            <Edit2 size={18} />
                                        </button>
                    ...
                    <div className="bg-white/60 backdrop-blur-md rounded-[32px] p-8 border border-white shadow-xl shadow-gray-200/10">
                        <div className="flex items-center justify-between mb-8">
                            <h2 className="text-2xl font-black text-gray-900">Employment History</h2>
                            <button className="p-2 bg-gray-50 text-[#1E7B7C] rounded-xl hover:bg-[#E8F4F4] transition-colors border border-gray-100">
                                <Plus size={20} />
                            </button>
                        </div>
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={idx} className="flex gap-4 p-5 border border-gray-100 rounded-2xl bg-white/40 hover:border-[#1E7B7C]/20 transition-colors group">
                                    <div className="cursor-grab active:cursor-grabbing text-gray-300 hover:text-gray-500 pt-1">
                                        <GripVertical size={20} />
                                    </div>
                                    <div className="p-3 bg-gray-50 rounded-xl text-gray-400 h-fit">
                                        <Briefcase size={24} />
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex justify-between items-start mb-1">
                                            ...
                                            <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button className="text-gray-400 hover:text-[#1E7B7C]"><Edit2 size={16} /></button>
                                        ...
                                        <p className="text-xs font-medium text-gray-500 mt-1">{job.period}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-white/60 backdrop-blur-md rounded-[32px] p-8 border border-white shadow-xl shadow-gray-200/10">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <button className="p-2 bg-gray-50 text-[#1E7B7C] rounded-xl"><Plus size={16} /></button>
                            </div>

                            <div className="space-y-4">
                                <div className="flex gap-4 p-4 border border-gray-100 rounded-2xl bg-white/40">
                                    <div className="p-2 bg-gray-50 rounded-xl text-gray-400 h-fit"><GraduationCap size={20} /></div>
                                    <div>
                                        <h4 className="font-black text-gray-900 text-sm">Bachelor's Degree in Business</h4>
                                        <p className="text-xs font-bold text-[#1E7B7C] mb-1">NYU Stern</p>
                                        <p className="text-[10px] text-gray-500">2011 - 2015</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/60 backdrop-blur-md rounded-[32px] p-8 border border-white shadow-xl shadow-gray-200/10">
                            <div className="flex items-center justify-between mb-8">
                                <h2 className="text-xl font-black text-gray-900">Certifications</h2>
                                <button className="p-2 bg-gray-50 text-[#1E7B7C] rounded-xl"><Plus size={16} /></button>
                            </div>

                            <div className="space-y-4">
                                <div className="flex gap-4 p-4 border border-gray-100 rounded-2xl bg-white/40">
                                    <div className="p-2 bg-gray-50 rounded-xl text-gray-400 h-fit"><Award size={20} /></div>
                                    <div>
                                        <h4 className="font-black text-gray-900 text-sm">Certified Green Cleaning Pro</h4>
                                        <p className="text-xs font-bold text-[#1E7B7C] mb-1">ISSA</p>
                                        <p className="text-[10px] text-gray-500">Issued Jan 2020</p>
                                    </div>
                                </div>
                            </div>
                        </div>

        ...
        <div className="max-w-6xl relative pb-24">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <div className="relative flex-1 max-w-lg">
                    ...
                    <input
                        ...
                        className="w-full bg-white/60 backdrop-blur-md border-transparent rounded-2xl py-4 pl-12 pr-4 text-sm font-bold focus:ring-2 focus:ring-[#1E7B7C]/20 shadow-sm transition-all"
                    />
                </div>
                <div className="flex gap-2">
                    <button className="px-6 py-4 bg-white/60 backdrop-blur-md text-gray-700 font-bold text-sm rounded-2xl hover:bg-white transition-colors shadow-sm whitespace-nowrap">
                        Category
                    </button>
                    <button className="px-6 py-4 bg-white/60 backdrop-blur-md text-gray-700 font-bold text-sm rounded-2xl hover:bg-white transition-colors shadow-sm whitespace-nowrap">
                        Availability
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {savedProviders.map((provider) => (
                    <div key={provider.id} className="bg-white/60 backdrop-blur-md rounded-[32px] border border-white shadow-xl shadow-gray-200/10 overflow-hidden group hover:shadow-2xl transition-all duration-500 flex flex-col">
                        <div className="p-6 pb-0 relative">
                            {/* Saved Heart Button */}
                            <button className="absolute top-6 right-6 p-2.5 bg-white/80 backdrop-blur-md rounded-xl text-red-500 hover:scale-110 active:scale-95 transition-all shadow-sm z-10 group/btn">
                            ...
                            <div className="flex flex-col items-center text-center">
                                ...
                                <div className="flex flex-col items-center">
                                    <Link href="#" className="flex items-center gap-1.5 mb-1 group/name">
                                        <h3 className="text-xl font-black text-gray-900 group-hover/name:text-[#1E7B7C] transition-colors">{provider.name}</h3>
                                ...
                                <div className="flex items-center gap-4 text-xs font-bold text-gray-500 w-full justify-center mb-6">
                        ...
                        <div className="px-6 pb-6 mt-auto">
                            <div className="flex flex-wrap gap-2 mb-6 justify-center">
                                {provider.skills.map(skill => (
                                    <span key={skill} className="text-[10px] font-black uppercase tracking-widest text-gray-500 bg-gray-100/80 px-2 py-1.5 rounded-md">
                                        {skill}
                                    </span>
                                ))}
                            </div>
                            ...
                            <div className="flex gap-3">
                                <button className="flex-1 py-3 bg-gray-50 hover:bg-[#E8F4F4] text-[#1E7B7C] rounded-2xl font-bold text-sm transition-colors border border-gray-100">
                                    Message
                                </button>
                ...
                {savedProviders.length < 4 && (
                    <div className="bg-gray-50/50 rounded-[32px] border-2 border-dashed border-gray-200 flex flex-col items-center justify-center p-8 text-center min-h-[400px]">
                        ...
                        <h3 className="text-lg font-black text-gray-900 mb-2">Find More Providers</h3>
                        <p className="text-sm font-bold text-gray-500 mb-6 max-w-[200px]">
                            Explore top-rated professionals in your area.
                        </p>
                        <Link href="/services/all" className="px-6 py-3 bg-white text-[#1E7B7C] rounded-xl font-bold text-sm hover:shadow-md transition-all">
                            Browse Services
                        </Link>
                    </div>
                )}

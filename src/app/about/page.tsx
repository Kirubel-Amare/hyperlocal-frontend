  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1600px] mx-auto px-8 pt-28 pb-12">
              ...
              {milestones.map((milestone, i) => (
                <div key={i} className="flex items-center gap-8">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#1E7B7C] to-[#166566] rounded-full text-white font-bold">
                      {i + 1}
                    </div>
                  </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {team.map((member, i) => (
                <div key={i} className="group text-center">
                  <div className="mb-6 overflow-hidden rounded-2xl border-4 border-[#E8F4F4] group-hover:border-[#1E7B7C] transition-all">
                  ...
                  <p className="text-[#1E7B7C] font-semibold text-sm mt-1">{member.role}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Stats */}
        <section className="py-20 px-6 bg-gradient-to-r from-[#1E7B7C] to-[#166566] rounded-3xl mb-12">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              <div>
                <p className="text-4xl font-black text-white mb-2">50K+</p>
                <p className="text-[#E8F4F4]">Verified Professionals</p>
              </div>
              <div>
                <p className="text-4xl font-black text-white mb-2">100K+</p>
                <p className="text-[#E8F4F4]">Happy Customers</p>
              </div>
              <div>
                <p className="text-4xl font-black text-white mb-2">500K+</p>
                <p className="text-[#E8F4F4]">Tasks Completed</p>
              </div>
              <div>
                <p className="text-4xl font-black text-white mb-2">50+</p>
                <p className="text-[#E8F4F4]">Cities Served</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/register" className="bg-gradient-to-r from-[#1E7B7C] to-[#166566] text-white px-10 py-4 rounded-xl font-bold hover:shadow-lg transition-all">
                Get Started
              </Link>
              <Link href="/contact" className="border-2 border-[#1E7B7C] text-[#1E7B7C] px-10 py-4 rounded-xl font-bold hover:bg-[#E8F4F4] transition-all">
                Contact Us
              </Link>
            </div>
          </div>

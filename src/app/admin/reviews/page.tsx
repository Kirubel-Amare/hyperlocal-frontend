    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 dark:text-gray-100 tracking-tight mb-2 italic">Review Management</h1>
                    <p className="text-gray-500 dark:text-gray-400 font-medium italic">Moderate platform feedback, handle inappropriate content, and monitor service quality.</p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-6">
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 p-6 rounded-[2rem] shadow-sm">
                    <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 italic">Total Reviews</p>
                    <h3 className="text-2xl font-black text-gray-900 dark:text-gray-100">{reviewList.length}</h3>
                </div>
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 p-6 rounded-[2rem] shadow-sm">
                    <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 text-emerald-500 italic">Avg. Rating</p>
                    <h3 className="text-2xl font-black text-gray-900 dark:text-gray-100">{avgRating} ★</h3>
                </div>
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 p-6 rounded-[2rem] shadow-sm">
                    <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 text-amber-500 italic">Flagged</p>
                    <h3 className="text-2xl font-black text-gray-900 dark:text-gray-100">{reviewList.filter(r => r.status === 'Flagged').length}</h3>
                </div>
                <div className="bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 p-6 rounded-[2rem] shadow-sm">
                    <p className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-1 text-red-500 italic">Deleted (Session)</p>
                    <h3 className="text-2xl font-black text-gray-900 dark:text-gray-100">{initialReviews.length - reviewList.length}</h3>
                </div>
            </div>
                    ...
                    <table className="w-full border-collapse">
                        <thead>
                            <tr className="bg-gray-50/50 dark:bg-gray-900/50">
                                <th className="px-6 py-4 text-left text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Review & Comment</th>
                                <th className="px-6 py-4 text-left text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Entities</th>
                                ...
                                <th className="px-6 py-4 text-left text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Job ID</th>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {filteredReviews.length > 0 ? filteredReviews.map((rev) => (
                                <tr key={rev.id} className="group hover:bg-gray-50/50 dark:bg-gray-900/50 transition-colors">
                                    <td className="px-6 py-5">
                                        <div className="flex flex-col max-w-[350px]">
                                            ...
                                            <p className="text-xs text-gray-700 dark:text-gray-300 font-bold leading-relaxed line-clamp-2 italic">"{rev.comment}"</p>
                                            <span className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-1 italic">ID: {rev.id}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                        <div className="flex flex-col gap-1">
                                            <div className="flex items-center gap-2">
                                                <span className="text-xs font-bold text-gray-700 dark:text-gray-300 italic">By: {rev.customer}</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <span className="text-xs font-bold text-gray-400 dark:text-gray-500 italic">For: {rev.provider}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
                                    ...
                                    <td className="px-6 py-5">
                                        <span className="text-xs font-bold text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-900 px-2 py-1 rounded-lg border border-gray-100 dark:border-gray-800 italic">{rev.jobId}</span>
                                    </td>
                                    <td className="px-6 py-5">
                                        <span className="text-sm font-bold text-gray-500 dark:text-gray-400 italic">{rev.date}</span>
                                    </td>

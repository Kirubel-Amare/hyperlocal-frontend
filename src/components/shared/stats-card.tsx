...
export default function StatsCard({
    ...
    return (
        <div className="bg-white/60 backdrop-blur-md rounded-[32px] p-8 shadow-xl shadow-gray-200/20 border border-white flex flex-col justify-between min-h-[192px] hover:translate-y-[-4px] transition-all group">
            ...
            <div>
                ...
                {trend && (
                    <div className={`text-sm font-black flex items-center gap-1.5 w-fit px-2 py-1 rounded-lg ${trendUp ? 'text-emerald-500 bg-emerald-50' : 'text-gray-400 bg-gray-50'
                        }`}>
